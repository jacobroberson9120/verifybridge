const CACHE='verifybridge-v10';
const ASSETS=['./','./index.html','./style.css','./app.js','./engine.js','./guidance.js','./i18n.js','./link-lens.js','./live-scan.js','./monitor.js','./model.json','./manifest.webmanifest','./icon.svg'];
